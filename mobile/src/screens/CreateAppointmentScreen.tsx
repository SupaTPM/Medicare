...
import { AvailabilitySlot, DoctorOption, Patient } from "@/types";
      ...
      {saved ? (
        <View style={styles.savedBox}>
          <View style={styles.savedHeader}>
            <Text style={styles.savedTitle}>Turno bloqueado</Text>
            <StatusPill label="QR listo" tone="green" />
          </View>
          <Text style={styles.savedText}>La cita se guardo y el turno quedo bloqueado hasta cierre medico.</Text>
        </View>
      ) : null}
      <PrimaryButton
        disabled={!canSave}
        icon="qr-code-outline"
        label={saved ? "Volver al panel" : saving ? "Guardando..." : "Guardar Turno"}
        loading={saving}
